...
class GitHubLoader {
    static async loadRemoteRepository(chatProvider) {
    ...
    static constructApiUrl(repoUrl) {
    ...
    static async fetchRepoContent(apiUrl, headers, page = 1, repoContent = []) {
    ...
    static async fetchFileContent(fileUrl, headers) {
