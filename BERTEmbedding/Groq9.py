...
def hybrid_search_and_answer(question, directory):
    ...
    if context:
        ...
        Instructions: Return only the complete code and nothing else, do not leave any method or part of function umimplemented, Do not include any explanations or comments.
        Answer:
        """
